...
The city has one parliamentary seat and six seats in the Legislative Assembly
							...
							<a href="indexhistory.html#section2" class="feature-content-link green-btn">History</a>
						</div>
					</div>
					<div class="col-sm-4">
						<div class="feature-content">
...
Another rail line passing through the district, starts at Kharagpur and ends at Gomoh,Dhanbad Rail Division is the second largest in terms of revenue generation after the Mumbai division.....</p>
							<a href="railways.html#section2" class="feature-content-link blue-btn">See Details</a>
						</div>
					</div>
					<div class="col-sm-4">
						<div class="feature-content">
							...
							<div class="row text-center">
								...
								<div class="col-lg-3 col-md-3 col-sm-6 col-xs-6 col-xxs-12">
									<div class="testimonial-content">
										...
										<p>Administrative services: P.N.Singh is the MP of Dhanbad<br>Raj sinha is the MP
										Chandra Shekhar Agarwal is the of Dhaxnabd associated with Eklavya Singh Deputy Mayor. The executive DC in Dhanbad Is Kripa nand Jha and the Ambuj Nath is the Judge of Dhanbad Court </p>
...
$query="INSERT INTO info(name,email,subject,message)values('$name','$email','$subject','$message')";
mysql_query($query);
mysql_close();
										...
										<p> Your feedback is submitted succesfully</p>
												</div>                            
										<a href="index.php" class="content-link">Home</a>	
